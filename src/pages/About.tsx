        ...
        <div className="container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
            {[
              ...
              <div
                key={index}
                className="rounded-xl overflow-hidden img-zoom-container aspect-[4/3] animate-fade-up"
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-16">
            {features.map((feature, index) => (
              <div
                key={feature.title}
                className="bg-card rounded-xl p-8 text-center card-shadow hover-lift animate-fade-up"
                style={{ animationDelay: `${index * 100}ms` }}
              >

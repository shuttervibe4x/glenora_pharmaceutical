      ...
      <section className="py-12 md:py-16">
        <div className="container">
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-16">
            {/* Map */}
            <div className="bg-muted rounded-xl overflow-hidden h-[400px] lg:h-auto animate-fade-right">
              <iframe
            ...
            {/* Contact Form */}
            <div className="bg-card rounded-xl p-8 card-shadow animate-fade-left">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {contactInfo.map((info, index) => (
              <div
                key={info.title}
                className="bg-card rounded-xl p-6 text-center card-shadow hover-lift animate-fade-up"
